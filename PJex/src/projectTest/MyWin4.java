...
public class MyWin4 extends JFrame implements ActionListener {
	...
	public void confirmExit() {
		int answer = JOptionPane.showConfirmDialog(this, "종료는 yes, 계속하려면 no", "윈도우를 종료하시겠습니까?", JOptionPane.YES_NO_OPTION);
